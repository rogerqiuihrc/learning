 ...
 * @since 2012-11-15
 */
Ext.define('Ext.ux.upload.UploadPanel', {
	...
	columns : [ {
		...
		dataIndex : 'percent',
		renderer : function(v) {
			var stml = '<div>' + '<div style="border:1px solid #008000;height:10px;width:115px;margin:2px 0px 1px 0px;float:left;">' + '<div style="float:left;background:#FFCC66;width:' + v + '%;height:8px;"><div></div></div>' + '</div>' +
...
//	flash_url : "swfupload/swfupload.swf",
	...
	upload_success_handler : function(file, serverData, responseReceived) {
		...
		// 执行回调函数
		me.upload_success_callback(Ext.JSON.decode(serverData));
	},
	upload_success_callback : function(result) {
